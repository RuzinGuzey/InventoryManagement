...
{
    public class CreateCommunicationCommandValidator : AbstractValidator<CreateCommunicationCommand>
    {
        private readonly IApplicationDbContext _dbContext;

        public CreateCommunicationCommandValidator(IApplicationDbContext dbContext)
        {
            ...
            RuleFor(p => p.EmployeeId)
                .MustAsync(HasEmployee).When(p => p.EmployeeId.HasValue).WithMessage("Bu Personel burada calismiyor!");
